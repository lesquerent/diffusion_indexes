...
def create_forecast_return_array(dict_of_tickers, history_period='6mo'):
    ...
    # results = models.create_var_model(array_of_principal_components)
    results = models.open_model('var_model_v1.pickle')
...
def make_prediction(period):
    forecast_return_ = create_forecast_return_array(const.tickers_CAC40_dict, '2mo')
    ...
    # model = models.create_linear_model(period)
    model = models.open_model('linear_model_v1.pickle')
