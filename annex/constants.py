tickers_CAC40_dict = {
						'Accor': 'AC.PA', 'Air Liquide': 'AI.PA',
						'Airbus': 'AIR.PA', 'ArcelorMittal': 'MT.AS', 'Atos': 'ATO.PA',
						...
						'Essilor': 'EL.PA', 'Hermès': 'RMS.PA', 'Kering': 'KER.PA', 
						"L'Oréal": 'OR.PA', 'Legrand': 'LR.PA', 'LVMH': 'MC.PA', 'Michelin': 'ML.PA',
						'Orange': 'ORA.PA', 'Pernod Ricard': 'RI.PA', 'PSA': 'UG.PA',
						'Publicis': 'PUB.PA', 'Renault': 'RNO.PA', 'Safran': 'SAF.PA', 
						'Saint-Gobain': 'SGO.PA', 'Sanofi': 'SAN.PA', 'Schneider Electric': 'SU.PA',
						'Société Générale': 'GLE.PA', 'Sodexo': 'SW.PA', 'STMicroelectronics': 'STM.PA', 
